package com.steffbeard.totalwar.bot.commands.moderation;
...
import com.steffbeard.totalwar.bot.utils.CalendarUtils;
import com.steffbeard.totalwar.bot.utils.EmbedSender;
import com.steffbeard.totalwar.bot.utils.Logger;
import com.steffbeard.totalwar.bot.utils.PermHandler;
import com.steffbeard.totalwar.bot.utils.Statics;
...
public class Clear implements Command {
    ...
    public void executed(boolean success, GuildMessageReceivedEvent event) {
        ...
        System.out.println(CalendarUtils.getCurrentSystemTime() + " [Info] [Commands]: Command .clear was executed by '" + event.getAuthor().getName() + "' (" + event.getGuild().getName() + ") in (" + event.getChannel().getId() + ") ");
    }

    @Override
    public String help() {
        return "USAGE: .clear <AmountOfMessages>";
    }
